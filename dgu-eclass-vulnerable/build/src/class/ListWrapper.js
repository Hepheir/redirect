class ListWrapper {
    static selectors = {
        listBox:        'div#listBox',
        listContent:    'div#listBox div.listContent',
        element:        'div#listBox div.listContent dl.element'
    }
    ...
    static getElements(ref_document) {
        ...
        nodeList = ref_document.querySelectorAll(cls.selectors.listBox);
